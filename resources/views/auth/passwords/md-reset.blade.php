                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <p class="card-text mb-2">Your account have been successfully verify please set your password</p>
                                <form class="auth-reset-password-form mt-2" action="{{ route('update-mda-user-password') }}" method="POST">
                                @csrf
