@extends('layouts.app', ['page' => 'vendor-registration-queried'])
                        ...
                        <div class="col-xl-3 col-md-4 col-12 invoice-actions mt-md-0 mt-2">
                            <div class="card shadow-none bg-transparent border-secondary">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">{{$registration->query_by->first_name}} {{$registration->query_by->sur_name}}</p>
                                    <p class="card-text"><span class="badge badge-light-secondary">{{\Carbon\Carbon::parse($registration->queried_at)->format('d M Y / h:i A')}}</span></p>
                                </div>
                            </div>
                        </div>
                        <!-- /Actions -->
