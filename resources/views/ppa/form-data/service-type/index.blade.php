@extends('layouts.app', ['page' => 'service-type'])
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Service Types</h2>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <form id="delete-form_{{$type->id}}"
                                                        action="{{ route('service-type.destroy', $type->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <a onclick="deleteData({{$type->id}})" class="dropdown-item" href="#">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body pb-5 px-sm-5 pt-50">
                            ...
                            <form id="createDataForm" class="row gy-1 pt-75" method="POST"
                                action="{{route('service-type.store')}}">
                                @csrf
                                @method('POST')
...
function editData(data){
    var _edit_route = '{{env('APP_URL')}}' + '/service-type/' + data.id;
