@extends('layouts.app', ['page' => 'service'])
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item" href="#"  onclick="editData({{$service}})">
                                                        <i data-feather="edit-2" class="me-50"></i>
                                                        <span>Edit</span>
                                                    </a>

                                                    <form id="delete-form_{{$service->id}}"
                                                        action="{{ route('service.destroy', $service->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <a onclick="deleteData({{$service->id}})" class="dropdown-item" href="#">
                        ...
                        <div class="modal-body pb-5 px-sm-5 pt-50">
                            ...
                            <form id="createDataForm" class="row gy-1 pt-75" method="POST"
                                ...
                                <div class="col-12 col-md-6">
                                    <label class="form-label" for="createTitle">Service Title</label>
                                ...
                                <div class="col-12 col-md-6">
                                    <label class="form-label" for="createType">Service Type</label>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body pb-5 px-sm-5 pt-50">
                            ...
                            <form id="editFormForm" class="row gy-1 pt-75" method="POST"
                                ...
                                <div class="col-12 col-md-6">
                                    <label class="form-label" for="editTitle">Service Title</label>
                                ...
                                <div class="col-12 col-md-6">
                                    <label class="form-label" for="editType">Service Type</label>
...
function editData(data){
    var _edit_route = '{{env('APP_URL')}}' + '/service/' + data.id;
    $("#editFormForm").attr("action", _edit_route);
    $("#editTitle").val(data.title);
    
    var ServiceTypes = <?php echo json_encode(app('App\Http\Services\BackendData')->ServiceTypes()); ?>;
    var _options_html = '';
